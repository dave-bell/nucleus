...
**Full Management Guide**: See `./project-intelligence-management.md`
...
- **Reference**: See `../../engine/overview.md` for system overview

## Related Files

- **Management Guide**: `./project-intelligence-management.md`
- **Context System**: `../../engine/overview.md`
- **Coding Standards Index**: `./standards/navigation.md`
- **Engine Standards Index**: `../../engine/standards/navigation.md`
