<!-- Context: domains/software-development/standards/security-patterns | Priority: high | Version: 1.0 | Updated: 2026-07-22 -->
...
These are language-agnostic patterns that apply to all programming languages. If your project has language-specific security context (e.g. a TypeScript or C# security guide), load that alongside this file rather than duplicating these patterns there.
